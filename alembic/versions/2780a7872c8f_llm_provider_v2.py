...
Revision ID: 2780a7872c8f
Revises: 6171727be56a
Create Date: 2026-03-09 16:59:43.766955
...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_agent_model_sources_id"), "agent_model_sources", ["id"], unique=True
    )
    op.create_index(
    ...
    op.create_table(
        ...
        sa.PrimaryKeyConstraint("id", name=op.f("pk_agent_discovered_models")),
        sa.UniqueConstraint(
            "catalog_ref", name=op.f("uq_agent_discovered_models_catalog_ref")
        ),
    )
    op.create_index(
    ...
    op.create_index(
        op.f("ix_agent_enabled_models_id"), "agent_enabled_models", ["id"], unique=True
    )
    op.add_column(
        "agent_preset",
...
def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_index(
        op.f("ix_agent_session_model_catalog_ref"), table_name="agent_session"
    )
    op.drop_column("agent_session", "model_catalog_ref")
    op.drop_index(op.f("ix_agent_preset_model_catalog_ref"), table_name="agent_preset")
    ...
    op.drop_index(
        op.f("ix_agent_enabled_models_catalog_ref"), table_name="agent_enabled_models"
    )
    ...
    op.drop_index(
        "ix_agent_discovered_models_source_id", table_name="agent_discovered_models"
    )
    op.drop_index(
        op.f("ix_agent_discovered_models_organization_id"),
        table_name="agent_discovered_models",
