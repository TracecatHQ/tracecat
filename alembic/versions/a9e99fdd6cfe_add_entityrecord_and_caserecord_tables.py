...
def upgrade() -> None:
    ...
    op.create_index('idx_record_gin', 'entity_record', ['data'], unique=False, postgresql_using='gin')
    ...
    op.create_index('idx_case_record_case_entity', 'case_record', ['case_id', 'entity_id'], unique=False)
    op.create_index('idx_case_record_entity', 'case_record', ['entity_id'], unique=False)
    op.alter_column('entity', 'owner_id',
...
def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    op.create_foreign_key('entity_field_owner_id_fkey', 'entity_field', 'workspace', ['owner_id'], ['id'], ondelete='CASCADE')
    op.alter_column('entity', 'owner_id',
               existing_type=sa.UUID(),
               nullable=False)
