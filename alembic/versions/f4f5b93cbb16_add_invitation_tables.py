...
Revision ID: f4f5b93cbb16
Revises: 45e411faf2e7
Create Date: 2026-01-22 12:41:17.114044
...
def upgrade() -> None:
    ...
    # Sync orgrole enum to uppercase BEFORE creating tables that use it
    # existing_server_default is what the default is BEFORE this migration runs
...
def downgrade() -> None:
    ...
    # Sync orgrole enum back to lowercase AFTER dropping tables that use it
    # existing_server_default is 'MEMBER' (uppercase) after the upgrade ran
    op.sync_enum_values(  # type: ignore[attr-defined]
        enum_schema="public",
        enum_name="orgrole",
        new_values=["member", "admin", "owner"],
