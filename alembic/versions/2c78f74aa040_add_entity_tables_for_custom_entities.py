"""add entity tables for custom entities

Revision ID: 2c78f74aa040
Revises: fbc309cb247f
Create Date: 2025-08-07 21:20:16.654884
...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_entity_metadata_id"), "entity_metadata", ["id"], unique=True
    )
    op.create_index(
        op.f("ix_entity_metadata_is_active"),
        "entity_metadata",
        ["is_active"],
        unique=False,
    )
    op.create_index(
        op.f("ix_entity_metadata_name"), "entity_metadata", ["name"], unique=False
    )
    op.create_table(
        "entity_data",
        sa.Column(
        ...
        sa.ForeignKeyConstraint(
            ["entity_metadata_id"], ["entity_metadata.id"], ondelete="CASCADE"
        ),
        sa.PrimaryKeyConstraint("surrogate_id"),
    )
    op.create_index(
    ...
    op.create_index(
        "idx_entity_metadata_id", "entity_data", ["entity_metadata_id"], unique=False
    )
    op.create_index(
        "idx_entity_owner_created",
        "entity_data",
        ["entity_metadata_id", "owner_id", "created_at"],
        unique=False,
    )
    ...
    op.create_table(
        ...
        sa.Column("description", sqlmodel.sql.sqltypes.AutoString(), nullable=True),
        sa.Column(
            "field_settings", postgresql.JSONB(astext_type=sa.Text()), nullable=True
        ),
        sa.Column("is_active", sa.Boolean(), nullable=False),
        ...
        sa.ForeignKeyConstraint(
            ["relation_target_entity_id"], ["entity_metadata.id"], ondelete="CASCADE"
        ),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["source_entity_metadata_id"], ["entity_metadata.id"], ondelete="CASCADE"
        ),
        sa.ForeignKeyConstraint(
            ["source_field_id"], ["field_metadata.id"], ondelete="CASCADE"
        ),
        sa.ForeignKeyConstraint(
            ["source_record_id"], ["entity_data.id"], ondelete="CASCADE"
        ),
        sa.ForeignKeyConstraint(
            ["target_entity_metadata_id"], ["entity_metadata.id"], ondelete="CASCADE"
        ),
        sa.ForeignKeyConstraint(
            ["target_record_id"], ["entity_data.id"], ondelete="CASCADE"
        ),
        sa.PrimaryKeyConstraint("id"),
        sa.UniqueConstraint(
            "source_record_id",
    ...
    op.create_index(
        "idx_relation_field_target",
        "entity_relation_link",
        ["source_field_id", "target_record_id"],
        unique=False,
    )
    op.create_index(
        "idx_relation_owner", "entity_relation_link", ["owner_id"], unique=False
    )
    op.create_index(
        "idx_relation_source",
        "entity_relation_link",
    ...
    op.create_index(
        op.f("ix_entity_relation_link_owner_id"),
        "entity_relation_link",
        ["owner_id"],
        unique=False,
    )
...
def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_index(
        op.f("ix_entity_relation_link_owner_id"), table_name="entity_relation_link"
    )
    ...
    op.drop_index(
        "idx_entity_data_gin", table_name="entity_data", postgresql_using="gin"
    )
