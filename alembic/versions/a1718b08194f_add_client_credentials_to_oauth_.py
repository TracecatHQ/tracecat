...
down_revision: Union[str, None] = 'f1654d579c16'
...
def upgrade() -> None:
    ...
    op.add_column('oauth_integration', sa.Column('encrypted_client_id', sa.LargeBinary(), nullable=True))
    op.add_column('oauth_integration', sa.Column('encrypted_client_secret', sa.LargeBinary(), nullable=True))
    op.add_column('oauth_integration', sa.Column('use_workspace_credentials', sa.Boolean(), nullable=False, server_default='false'))
