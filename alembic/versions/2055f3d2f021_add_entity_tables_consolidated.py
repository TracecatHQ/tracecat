...
def upgrade() -> None:
    ...
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('source_record_id', 'source_field_id', 'target_record_id', name='uq_record_relation_link_triple')
    )
    op.create_index('idx_record_relation_field_target', 'record_relation_link', ['source_field_id', 'target_record_id'], unique=False)
    op.create_index('idx_record_relation_owner', 'record_relation_link', ['owner_id'], unique=False)
    op.create_index('idx_record_relation_source', 'record_relation_link', ['source_record_id', 'source_field_id'], unique=False)
