...
# =============================================================================
# ToolExecutor Protocol Tests
# =============================================================================


class TestToolExecutorProtocol:
    """Tests for ToolExecutor protocol and SimpleToolExecutor."""

    def test_simple_tool_executor_has_run_method(self):
        """Test that SimpleToolExecutor has the required run method."""
        from tracecat.agent.tools import SimpleToolExecutor

        executor = SimpleToolExecutor()

        # Check protocol compliance (ToolExecutor is not runtime_checkable)
