...
def test_execute_child_workflow_validation_equivalence(registry_repo):
    ...
    """
    from tracecat.dsl.common import ResolvedSubflowInput
    ...
    model_validated = ResolvedSubflowInput.model_validate(valid_args)
    ...
    with pytest.raises(ValidationError):
        ResolvedSubflowInput.model_validate(invalid_args)
