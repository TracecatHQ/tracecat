...
module "eks" {
  ...
  agent_executor_mcp_queue                          = var.agent_executor_mcp_queue
  agent_executor_mcp_max_concurrent_activities      = var.agent_executor_mcp_max_concurrent_activities
  agent_executor_mcp_threadpool_max_workers         = var.agent_executor_mcp_threadpool_max_workers
  agent_executor_mcp_max_concurrent_local_sandboxes = var.agent_executor_mcp_max_concurrent_local_sandboxes
  agent_executor_mcp_sandbox_cache_dir              = var.agent_executor_mcp_sandbox_cache_dir
