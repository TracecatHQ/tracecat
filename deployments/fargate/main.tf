...
module "ecs" {
  ...
  auth_min_password_length = var.auth_min_password_length
  ...
  executor_warm_cache_max_workflow_definitions = var.executor_warm_cache_max_workflow_definitions
  executor_warm_cache_max_tarballs             = var.executor_warm_cache_max_tarballs
  executor_warm_ready_file                     = var.executor_warm_ready_file
  executor_healthcheck_interval                = var.executor_healthcheck_interval
  executor_healthcheck_timeout                 = var.executor_healthcheck_timeout
  executor_healthcheck_retries                 = var.executor_healthcheck_retries
  executor_healthcheck_start_period            = var.executor_healthcheck_start_period
