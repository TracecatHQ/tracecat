...
module "ecs" {
  ...
  agent_mcp_queue                          = var.agent_mcp_queue
  agent_mcp_max_concurrent_activities      = var.agent_mcp_max_concurrent_activities
  agent_mcp_threadpool_max_workers         = var.agent_mcp_threadpool_max_workers
  agent_mcp_max_concurrent_local_sandboxes = var.agent_mcp_max_concurrent_local_sandboxes
  agent_mcp_sandbox_cache_dir              = var.agent_mcp_sandbox_cache_dir
