...
class WorkspaceCopilotPrompts(BaseModel):
    ...
    def instructions(self) -> str:
        ...
        return textwrap.dedent("""
            ...
            IMPORTANT: Do not execute any actions or tools that are not explicitly requested by the user. You are an assistant, not a replacement for the user.
            IMPORTANT: If you have suggestions or recommendations based on the workspace, you must ask the user for explicit permission before proceeding.
