...
if TYPE_CHECKING:
    ...
    from tracecat.agent.types import AgentConfig, UnifiedMessage
...
class AgentSessionService(BaseWorkspaceService):
    ...
    async def append_messages(
        ...
        *,
        ...
        """Persist messages to AgentSessionHistory.

        Args:
            session_id: The session UUID.
            messages: The messages to persist.
            kind: The message kind (chat-message or internal).
        """
        ...
        for message in messages:
            # Serialize the message to JSONL format
        ...
        logger.debug(
            "Persisted messages to AgentSessionHistory",
            session_id=session_id,
