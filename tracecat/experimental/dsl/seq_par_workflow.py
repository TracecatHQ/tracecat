...
class SequentialStatement(_DSLNode):
    ...
    def append(self, other: Statement) -> SequentialStatement:
        """Append another Statement to this one."""
        return SequentialStatement(sequence=self.sequence + [other])

    def merge(self, other: SequentialStatement) -> SequentialStatement:
        """Join a list of Statements to this one."""
        return SequentialStatement(sequence=self.sequence + other.sequence)
