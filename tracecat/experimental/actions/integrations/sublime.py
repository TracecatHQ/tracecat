...
@registry.register(
    namespace="sublime",
    description="Explode a binary file and get results",
    secrets=["sublime"],
)
def explode_binary(
...
@registry.register(
    namespace="sublime",
    description="Hunt for messages using MQL",
    secrets=["sublime"],
)
def hunt_messages(
    query: str,
...
@registry.register(
    namespace="sublime",
    description="Classify message groups",
    secrets=["sublime"],
)
...
@registry.register(
    namespace="sublime",
    description="Quarantine messages",
    secrets=["sublime"],
)
...
@registry.register(
    namespace="sublime",
    description="Score existing message given ID",
    secrets=["sublime"],
)
def score_message(
...
@registry.register(
    namespace="sublime",
    description="Restore trashed message given ID",
    secrets=["sublime"],
)
def restore_message(
...
@registry.register(
    namespace="sublime",
    description="List user phishing reports",
    secrets=["sublime"],
)
