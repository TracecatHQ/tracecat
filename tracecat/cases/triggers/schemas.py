...
class CaseTriggerExecutionMode(StrEnum):
    """Execution mode for case-triggered workflows."""
...
class CaseWorkflowTriggerConfig(Schema):
    ...
    execution_mode: CaseTriggerExecutionMode = Field(
        default=CaseTriggerExecutionMode.PUBLISHED_ONLY,
        description=(
            "Which workflow version to execute when this trigger matches. "
            "Defaults to published-only for backward compatibility."
        ),
    )
