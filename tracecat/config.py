...
TRACECAT__REGISTRY_SYNC_BUILTIN_USE_INSTALLED_SITE_PACKAGES = os.environ.get(
    "TRACECAT__REGISTRY_SYNC_BUILTIN_USE_INSTALLED_SITE_PACKAGES", "false"
).lower() in ("true", "1")
"""Use installed site-packages for builtin registry tarball builds.

When True, builtin tracecat_registry sync packages the current
...
When False (default), builtin sync builds artifacts from source so wheels are
resolved for the executing runtime architecture.
"""
