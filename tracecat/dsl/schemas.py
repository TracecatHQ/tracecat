...
class ActionRetryPolicy(BaseModel):
    max_attempts: int = Field(
        ...
        description=(
            ...
            "retries. Covers exceptions raised by the action as well as transient "
            "executor failures (sandbox crash, sandbox or executor timeout, result "
            "storage unavailable). Deterministic failures such as sandbox policy "
            "violations, resource-limit kills, missing permissions, or entitlement "
