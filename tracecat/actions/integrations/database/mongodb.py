...
async def get_mongodb_document(
    search_field: Annotated[
        str, Field(..., description="The field to search for (i.e. 'elastic_namespace').")
    ],
    search_value: Annotated[
        str, Field(..., description="The value to search for in the specified field (i.e. 'jira_id').")
    ],
    return_field: Annotated[
        Optional[str], Field(None, description="Comma-separated list of fields you wish to return in this search. When left blank, the whole document is returned.")
    ] = None
) -> dict[str, Any] | None:
