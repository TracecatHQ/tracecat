...
export const SelectedWorkflowProvider: React.FC<{ children: ReactNode }> = ({ children }) => {
  const [selectedWorkflowMetadata, setSelectedWorkflowMetadata] = useState<WorkflowMetadata>({ id: undefined, title: undefined, description: undefined, status: undefined });

  return (
    <SelectedWorkflowContext.Provider value={{ selectedWorkflowMetadata, setSelectedWorkflowMetadata }}>
      {children}
