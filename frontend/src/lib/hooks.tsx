...
import {
  ...
  type GroupAssignmentCreate,
  type GroupAssignmentReadWithDetails,
...
export function useRbacAssignments(options?: {
  ...
  const {
    ...
    isLoading,
    error,
  } = useQuery<GroupAssignmentReadWithDetails[]>({
  ...
  const {
    ...
    mutationFn: async (params: GroupAssignmentCreate) =>
  ...
  const {
    ...
    mutationFn: async ({
      assignmentId,
      ...params
    }: GroupAssignmentUpdate & { assignmentId: string }) =>
