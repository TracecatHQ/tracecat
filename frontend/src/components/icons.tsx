...
export const UDFIcons: Record<string, (props: CustomIconProps) => JSX.Element> =
  {
    ...
    "tools.onepassword": createIconRenderer(OnePasswordIcon),
    "tools.onepassword_sdk": createIconRenderer(OnePasswordIcon),
...
export function MistralIcon({ className, ...rest }: IconProps) {
  return (
    <svg
      viewBox="0 0 24 24"
      role="img"
