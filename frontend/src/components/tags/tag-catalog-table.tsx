...
/** Tag shape expected by the catalog table. */
interface TagItem {
  id: string
  name: string
  ref: string
...
interface TagCatalogTableProps {
  tags: TagItem[]
...
export function TagCatalogTable({
  tags,
  onDeleteTag,
  onUpdateTag,
  isDeleting,
        ...
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              ...
              and will remove this tag from all {resourceLabel}.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
...
const defaultToolbarProps: DataTableToolbarProps<TagItem> = {
  filterProps: {
