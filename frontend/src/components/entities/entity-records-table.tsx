...
export function EntityRecordsTable({ entityId }: { entityId: string }) {
  ...
  const columns: ColumnDef<RecordRead, unknown>[] = [
    {
      ...
      cell: ({ row }) => {
        ...
        const summary =
          ...
          "—"
        return (
          <div className="text-xs text-foreground/80 truncate max-w-[420px]">
            {summary}
          </div>
        )
      },
  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center gap-2">
        <Label
          htmlFor="entity-records-include-deleted"
          className="text-xs text-muted-foreground"
        >
          Include deleted
        </Label>
        <Switch
          id="entity-records-include-deleted"
      ...
      <DataTable
        ...
        tableId={`entity-records:${entityId}`}
