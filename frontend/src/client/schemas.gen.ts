...
export const $RFEdge = {
    ...
    title: 'RFEdge',
    description: 'React Flow Graph Edge.'
} as const;

export const $RFGraph = {
    properties: {
        nodes: {
            items: {
                '$ref': '#/components/schemas/RFNode'
            },
            type: 'array',
            title: 'Nodes'
        },
    ...
    type: 'object',
    title: 'RFGraph',
    description: `React Flow Graph Object.
...
export const $RFNode = {
    properties: {
        id: {
            type: 'string',
            title: 'Id',
            description: 'RF Graph Node ID, not to confuse with action ref'
        },
        type: {
            type: 'string',
            enum: ['trigger', 'udf'],
        ...
        data: {
            anyOf: [
                {
                    '$ref': '#/components/schemas/UDFNodeData'
                },
                {
    ...
    title: 'RFNode',
    description: 'Base React Flow Graph Node.'
} as const;
...
export const $TriggerNodeData = {
    properties: {
        ...
        title: {
            type: 'string',
            title: 'Title',
            description: 'Action title, used to generate the action ref',
            default: 'Trigger'
        },
        webhook: {
            type: 'object',
...
export const $WorkflowMetadataResponse = {
    ...
    type: 'object',
    required: ['id', 'title', 'description', 'status', 'created_at', 'updated_at', 'version'],
...
export const $WorkflowResponse = {
    properties: {
        ...
        view: {
            '$ref': '#/components/schemas/RFGraph'
        },
        definition: {
    ...
    type: 'object',
    required: ['id', 'meta', 'view', 'definition'],
    title: 'WorkflowResponse',
    description: 'Concretely typed workflow model.'
} as const;
