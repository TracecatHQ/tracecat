...
export const $CaseEventRead = {
  oneOf: [
    ...
    {
      $ref: "#/components/schemas/ViewedEventRead",
    },
    {
  ...
  discriminator: {
    ...
    mapping: {
      ...
      case_viewed: "#/components/schemas/ViewedEventRead",
...
export const $FeatureFlag = {
  type: "string",
  enum: ["git-sync", "agent-sandbox", "case-durations", "case-tasks"],
  title: "FeatureFlag",
