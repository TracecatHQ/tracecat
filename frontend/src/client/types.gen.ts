...
export type AgentSettingsRead = {
  ...
  agent_approval_manager_preset_id: string | null
}
...
export type AgentSettingsUpdate = {
  ...
  agent_case_chat_inject_content?: boolean
  /**
   * Preset ID used as the default approval manager agent.
   */
  agent_approval_manager_preset_id?: string | null
}
 ...
 */
export type ApprovalRecommendationVerdict = "approve" | "reject" | "manual"
