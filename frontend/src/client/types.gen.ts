...
export type FunctionMeta = {
  name: string
  description: string
  parameters: Array<ParameterMeta>
  return_type: string
}
...
export type RegistryActionsValidateRegistryActionResponse =
  RegistryActionValidateResponse

export type EditorGetFunctionsResponse = Array<FunctionMeta>
