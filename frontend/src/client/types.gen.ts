...
export type RFGraph = {
    nodes?: Array<RFNode>;
    edges?: Array<RFEdge>;
    [key: string]: unknown | RFNode | RFEdge;
};
...
export type RFNode = {
    /**
     * RF Graph Node ID, not to confuse with action ref
     */
    id: string;
    type: 'trigger' | 'udf';
    position?: Position;
    positionAbsolute?: Position;
    data: UDFNodeData | TriggerNodeData;
    [key: string]: unknown | string | Position;
};

export type type = 'trigger' | 'udf';
...
export type UDFNodeData = {
    ...
    [key: string]: unknown | boolean | number | string;
};
...
export type WorkflowsUpdateWorkflowResponse = WorkflowResponse;
...
export type ActionsListActionsResponse = Array<ActionStatement>;
