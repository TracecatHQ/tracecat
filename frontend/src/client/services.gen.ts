...
import type {
  ...
  RegistryActionsRunRegistryActionResponse,
  RegistryActionsUpdateRegistryActionData,
  RegistryActionsUpdateRegistryActionResponse,
  RegistryActionsValidateRegistryActionData,
  RegistryActionsValidateRegistryActionResponse,
 ...
 * @throws ApiError
 */
export const registryRepositoriesSyncRegistryRepositories = (
  data: RegistryRepositoriesSyncRegistryRepositoriesData = {}
): CancelablePromise<RegistryRepositoriesSyncRegistryRepositoriesResponse> => {
  return __request(OpenAPI, {
    method: "POST",
 ...
 * @throws ApiError
 */
export const registryActionsRunRegistryAction = (
  data: RegistryActionsRunRegistryActionData
): CancelablePromise<RegistryActionsRunRegistryActionResponse> => {
  return __request(OpenAPI, {
    method: "POST",
 ...
 * @throws ApiError
 */
export const registryActionsValidateRegistryAction = (
  data: RegistryActionsValidateRegistryActionData
): CancelablePromise<RegistryActionsValidateRegistryActionResponse> => {
  return __request(OpenAPI, {
    method: "POST",
