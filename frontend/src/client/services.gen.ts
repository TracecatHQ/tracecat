...
/**
 * Saml:Database.Authorize
 * Get the SAML redirect URL from the SSO Ready API.
 * @param data The data for the request.
 * @param data.organizationExternalId
 * @returns SamlAuthorizeResponse Successful Response
 * @throws ApiError
 */
export const authSamlDatabaseAuthorize = (data: AuthSamlDatabaseAuthorizeData): CancelablePromise<AuthSamlDatabaseAuthorizeResponse> => { return __request(OpenAPI, {
    method: 'GET',
    url: '/auth/saml/authorize',
    query: {
        organization_external_id: data.organizationExternalId
    },
    errors: {
        422: 'Validation Error'
    }
...
/**
 * Saml:Database.Callback
 * Redeem the SAML access code.
 * @param data The data for the request.
 * @param data.samlAccessCode
 * @returns unknown Successful Response
 * @throws ApiError
 */
export const authSamlDatabaseCallback = (data: AuthSamlDatabaseCallbackData): CancelablePromise<AuthSamlDatabaseCallbackResponse> => { return __request(OpenAPI, {
    method: 'GET',
    url: '/auth/saml/callback',
    query: {
        saml_access_code: data.samlAccessCode
    },
    errors: {
        422: 'Validation Error'
    }
