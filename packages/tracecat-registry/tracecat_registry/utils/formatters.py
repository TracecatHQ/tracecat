...
Copied from tracecat/expressions/formatters.py to allow registry actions
...
from pydantic_core import to_jsonable_python as _pydantic_to_jsonable


def to_jsonable_python(value: Any) -> Any:
    """Convert a value to a JSONable Python object.

    Drops nulls and uses fallback for unknown values.
    ...
    return _pydantic_to_jsonable(value, fallback=fallback, exclude_none=True)
