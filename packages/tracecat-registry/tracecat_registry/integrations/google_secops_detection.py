...
async def list_rules(
    ...
    page_token: Annotated[
        str | None, Field(description="Token for pagination")
    ] = None,
) -> dict[str, Any]:
    """
...
async def list_detections(
    ...
    rule_id: Annotated[
        str, Field(description="The rule ID to get detections for")
    ],
    start_time: Annotated[
        str | None,
        Field(
            description="Start time (RFC 3339 format, e.g., '2024-01-01T00:00:00Z')"
        ),
    ] = None,
    end_time: Annotated[
...
async def create_retrohunt(
    ...
    rule_id: Annotated[
        str, Field(description="The rule ID to run retrohunt for")
    ],
    start_time: Annotated[
        str,
        Field(
