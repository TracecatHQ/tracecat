...
TRACECAT_API_RAM = os.getenv("TRACECAT__API_RAM", 3072)

TRACECAT_WORKER_CPU = os.getenv("TRACECAT__WORKER_CPU", 2048)
TRACECAT_WORKER_RAM = os.getenv("TRACECAT__WORKER_RAM", 6144)

TRACECAT_UI_CPU = os.getenv("TRACECAT__UI_CPU", 2048)
TRACECAT_UI_RAM = os.getenv("TRACECAT__UI_RAM", 4096)

TEMPORAL_SERVER_CPU = os.getenv("TEMPORAL__SERVER_CPU", 2048)
TEMPORAL_SERVER_RAM = os.getenv("TEMPORAL__SERVER_RAM", 4096)

TEMPORAL_UI_CPU = os.getenv("TEMPORAL__UI_CPU", 256)
TEMPORAL_UI_RAM = os.getenv("TEMPORAL__UI_RAM", 512)
