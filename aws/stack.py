...
class TracecatEngineStack(Stack):
    def __init__(self, scope: Construct, id: str, **kwargs) -> None:
        ...
        api_container = api_task_definition.add_container(  # noqa
            ...
            environment=api_env,
            secrets=api_secrets,
            port_mappings=[ecs.PortMapping(container_port=80, name="api")],
        ...
        runner_container = runner_task_definition.add_container(  # noqa
            ...
            port_mappings=[ecs.PortMapping(container_port=80, name="runner")],
            logging=ecs.LogDrivers.aws_logs(
        ...
        scheduler_task_definition.add_container(  # noqa
            ...
            port_mappings=[ecs.PortMapping(container_port=80, name="scheduler")],
            logging=ecs.LogDrivers.aws_logs(
