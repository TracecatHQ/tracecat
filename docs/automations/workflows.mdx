...
- [Subflow run action](/automations/core-actions/subflows)
- [Case triggers](/automations/triggers/cases) <Badge icon="lock" color="blue" size="lg" shape="pill">Enterprise</Badge>
- [Task triggers](/automations/triggers/tasks) <Badge icon="lock" color="blue" size="lg" shape="pill">Enterprise</Badge>
- [Comment triggers](/automations/triggers/comments) <Badge icon="lock" color="blue" size="lg" shape="pill">Enterprise</Badge>
