---
title: "Workflows"
description: "Learn how Tracecat workflows work and how to manage them: run them manually, draft and publish definitions, tag and rename, and configure workflow settings."
---

import CoreActionsPointer from "/snippets/core-actions-pointer.mdx";
...
Right click on a workflow in the workflows table then select the "Rename workflow" menu item.

![Rename workflow](/img/automations/workflows/rename-workflow.png)

You can also rename a workflow from the builder. Double click the workflow name in the breadcrumb, or click the pencil icon beside it. Press `Enter` or click away to save, or press `Escape` to cancel.

![Rename workflow in the builder](/img/automations/workflows/rename-workflow-builder.png)
...
<Badge icon="lock" color="blue" size="lg" shape="pill">Enterprise</Badge> users should use Tracecat's [Git sync](/manage-platform/git-sync) feature to push and pull their workflow definitions directly from a remote Git repository.
