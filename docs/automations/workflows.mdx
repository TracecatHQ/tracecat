...
![Trigger inputs](/img/automations/workflows/trigger-inputs.png)
...
![Workflow alias](/img/automations/workflows/workflow-alias.png)
...
![Error workflow](/img/automations/workflows/error-workflow.png)
...
![Input schema](/img/automations/workflows/input-schema.png)
...
![Output schema](/img/automations/workflows/output-schema.png)
