...
description: "YAML reference for Tracecat workflow definitions: triggers, actions, inputs, outputs, control flow, and schema fields used to author and version workflows."
---
...
actions:
  - ref: run_subflow
    ...
    args:
      workflow_id: wf_6dKVihiTHnzsxznV2Wku3S
      trigger_inputs:
        alert: ${{ var.alert }}
returns: null
```
