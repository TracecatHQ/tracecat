---
title: "Tracecat MCP"
description: "Drive Tracecat from your own agent harness over MCP: build, edit, and run workflows and cases through Claude Code, OpenAI Codex, GitHub Copilot, or any MCP client."
---
...
Tracecat works best with agentic coding tools (Claude Code, OpenAI Codex, GitHub Copilot, OpenCode).
