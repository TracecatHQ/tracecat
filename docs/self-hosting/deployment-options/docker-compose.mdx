...
curl -o env.sh https://raw.githubusercontent.com/TracecatHQ/tracecat/0.40.0/env.sh
...
- Read inline comments in the generated `.env` file to better understand Tracecat's configurations. [View `.env.example` file](https://github.com/TracecatHQ/tracecat/blob/0.40.0/.env.example).
