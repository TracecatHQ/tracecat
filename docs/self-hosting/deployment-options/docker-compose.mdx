...
curl -o env.sh https://raw.githubusercontent.com/TracecatHQ/tracecat/0.29.6/env.sh
...
```bash
curl -o Caddyfile https://raw.githubusercontent.com/TracecatHQ/tracecat/0.29.6/Caddyfile
```
...
- Read inline comments in the generated `.env` file to better understand Tracecat's configurations. [View `.env.example` file](https://github.com/TracecatHQ/tracecat/blob/0.29.6/.env.example).
