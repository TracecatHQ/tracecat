...
```bash
curl -o env.sh https://raw.githubusercontent.com/TracecatHQ/tracecat/0.11.7/env.sh
curl -o .env.example https://raw.githubusercontent.com/TracecatHQ/tracecat/0.11.7/.env.example
...
```bash
curl -o Caddyfile https://raw.githubusercontent.com/TracecatHQ/tracecat/0.11.7/Caddyfile
```

## Download Docker Compose File

```bash
curl -o docker-compose.yml https://raw.githubusercontent.com/TracecatHQ/tracecat/0.11.7/docker-compose.yml
```
...
- Read inline comments in the generated `.env` file to better understand Tracecat's configurations. [View `.env.example` file](https://raw.githubusercontent.com/TracecatHQ/tracecat/0.11.7/.env.example)
