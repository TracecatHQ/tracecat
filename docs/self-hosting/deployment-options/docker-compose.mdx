...
```bash
curl -o env.sh https://raw.githubusercontent.com/TracecatHQ/tracecat/0.17.0/env.sh
curl -o .env.example https://raw.githubusercontent.com/TracecatHQ/tracecat/0.17.0/.env.example
...
```bash
curl -o Caddyfile https://raw.githubusercontent.com/TracecatHQ/tracecat/0.17.0/Caddyfile
```

## Download Docker Compose File

```bash
curl -o docker-compose.yml https://raw.githubusercontent.com/TracecatHQ/tracecat/0.17.0/docker-compose.yml
```
