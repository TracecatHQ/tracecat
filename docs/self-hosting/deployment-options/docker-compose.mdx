...
curl -o env.sh https://raw.githubusercontent.com/TracecatHQ/tracecat/0.36.1/env.sh

# 2. Download the .env.example template file (env.sh needs this to generate your .env file)
curl -o .env.example https://raw.githubusercontent.com/TracecatHQ/tracecat/0.36.1/.env.example
...
```bash
curl -o Caddyfile https://raw.githubusercontent.com/TracecatHQ/tracecat/0.36.1/Caddyfile
```

## Download Docker Compose File

```bash
curl -o docker-compose.yml https://raw.githubusercontent.com/TracecatHQ/tracecat/0.36.1/docker-compose.yml
```
...
- Read inline comments in the generated `.env` file to better understand Tracecat's configurations. [View `.env.example` file](https://github.com/TracecatHQ/tracecat/blob/0.36.1/.env.example).
