...
The Qwen generation recommendations apply to its 1M-token YaRN configuration. Prompt, reasoning, and response tokens still share the total context window.
