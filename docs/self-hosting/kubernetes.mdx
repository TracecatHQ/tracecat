...
- External PostgreSQL 14 or newer instance (e.g., Amazon RDS, Cloud SQL)
...
Use PostgreSQL 14 or newer for the Tracecat application database. Case and table
aggregation actions use timezone-aware date bucketing in PostgreSQL.
