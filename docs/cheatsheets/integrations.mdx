...
| -------------- | --------------- | ----------------- |
| core           | http_poll       | `mtls`, `ca_cert` |
| core           | http_request    | `mtls`, `ca_cert` |
| core           | require         | -                 |
...
| Namespace              | Function                                | Secrets                               |
| ---------------------- | --------------------------------------- | ------------------------------------- |
| tools.alertmedia       | create_trip                             | `alertmedia`, `mtls`, `ca_cert`       |
| tools.alertmedia       | delete_trip                             | `alertmedia`, `mtls`, `ca_cert`       |
| tools.alertmedia       | get_travel_events                       | `alertmedia`, `mtls`, `ca_cert`       |
| tools.alertmedia       | get_user_trip_by_id                     | `alertmedia`, `mtls`, `ca_cert`       |
| tools.alertmedia       | get_user_trips                          | `alertmedia`, `mtls`, `ca_cert`       |
| tools.alertmedia       | search_trips                            | `alertmedia`, `mtls`, `ca_cert`       |
| tools.alertmedia       | search_users                            | `alertmedia`, `mtls`, `ca_cert`       |
| tools.alertmedia       | update_trip                             | `alertmedia`, `mtls`, `ca_cert`       |
...
| tools.crowdsec         | lookup_ip_address                       | `crowdsec_cti`, `mtls`, `ca_cert`     |
...
| tools.datadog          | list_security_signals                   | `datadog`, `mtls`, `ca_cert`          |
| tools.elastic_security | list_detection_signals                  | `elastic_security`, `mtls`, `ca_cert` |
| tools.falconpy         | call_command                            | `crowdstrike`                         |
| tools.google_api       | get_access_token                        | `google_api`                          |
| tools.google_maps      | get_location_data                       | `google_maps`, `mtls`, `ca_cert`      |
...
| tools.hackerone        | get_program                             | `hackerone`, `mtls`, `ca_cert`        |
| tools.hackerone        | get_programs                            | `hackerone`, `mtls`, `ca_cert`        |
| tools.hackerone        | get_report                              | `hackerone`, `mtls`, `ca_cert`        |
| tools.hackerone        | get_reports                             | `hackerone`, `mtls`, `ca_cert`        |
| tools.hibp             | check_email_breaches                    | `hibp`, `mtls`, `ca_cert`             |
| tools.hibp             | check_email_pastes                      | `hibp`, `mtls`, `ca_cert`             |
| tools.hibp             | get_all_breaches                        | `mtls`, `ca_cert`                     |
| tools.hibp             | get_breach_details                      | `mtls`, `ca_cert`                     |
| tools.hibp             | get_data_classes                        | `mtls`, `ca_cert`                     |
| tools.hibp             | get_latest_breach                       | `mtls`, `ca_cert`                     |
| tools.ipinfo           | lookup_ip_address                       | `ipinfo`, `mtls`, `ca_cert`           |
| tools.jira             | add_issue_comment                       | `jira`, `mtls`, `ca_cert`             |
| tools.jira             | assign_issue                            | `jira`, `mtls`, `ca_cert`             |
| tools.jira             | create_issue                            | `jira`, `mtls`, `ca_cert`             |
| tools.jira             | get_fields                              | `jira`, `mtls`, `ca_cert`             |
| tools.jira             | get_issue                               | `jira`, `mtls`, `ca_cert`             |
| tools.jira             | get_priorities                          | `jira`, `mtls`, `ca_cert`             |
| tools.jira             | get_priority_schemes                    | `jira`, `mtls`, `ca_cert`             |
| tools.jira             | get_projects                            | `jira`, `mtls`, `ca_cert`             |
| tools.jira             | get_transitions                         | `jira`, `mtls`, `ca_cert`             |
| tools.jira             | get_user_id                             | `jira`, `mtls`, `ca_cert`             |
| tools.jira             | search_issues                           | `jira`, `mtls`, `ca_cert`             |
| tools.jira             | update_issue_description                | `jira`, `mtls`, `ca_cert`             |
| tools.jira             | update_issue_fields                     | `jira`, `mtls`, `ca_cert`             |
| tools.jira             | update_issue_status                     | `jira`, `mtls`, `ca_cert`             |
| tools.jira             | upload_attachment                       | `jira`, `mtls`, `ca_cert`             |
...
| tools.okta             | activate_user                           | `okta`, `mtls`, `ca_cert`             |
| tools.okta             | add_to_group                            | `okta`, `mtls`, `ca_cert`             |
| tools.okta             | assign_group_to_app                     | `okta`, `mtls`, `ca_cert`             |
| tools.okta             | clear_user_sessions                     | `okta`, `mtls`, `ca_cert`             |
| tools.okta             | create_user                             | `okta`, `mtls`, `ca_cert`             |
| tools.okta             | expire_password                         | `okta`, `mtls`, `ca_cert`             |
| tools.okta             | expire_password_with_temporary_password | `okta`, `mtls`, `ca_cert`             |
| tools.okta             | get_group_members                       | `okta`, `mtls`, `ca_cert`             |
| tools.okta             | get_groups_assigned_to_user             | `okta`, `mtls`, `ca_cert`             |
| tools.okta             | get_user                                | `okta`, `mtls`, `ca_cert`             |
| tools.okta             | list_groups_in_org                      | `okta`, `mtls`, `ca_cert`             |
| tools.okta             | list_users                              | `okta`, `mtls`, `ca_cert`             |
| tools.okta             | lookup_user_by_email                    | `okta`, `mtls`, `ca_cert`             |
| tools.okta             | remove_from_group                       | `okta`, `mtls`, `ca_cert`             |
| tools.okta             | reset_password                          | `okta`, `mtls`, `ca_cert`             |
| tools.okta             | revoke_sessions                         | `okta`, `mtls`, `ca_cert`             |
| tools.okta             | search_users                            | `okta`, `mtls`, `ca_cert`             |
| tools.okta             | suspend_user                            | `okta`, `mtls`, `ca_cert`             |
| tools.okta             | unsuspend_user                          | `okta`, `mtls`, `ca_cert`             |
| tools.okta_oar         | create_message                          | `okta`, `mtls`, `ca_cert`             |
| tools.okta_oar         | get_requests                            | `okta`, `mtls`, `ca_cert`             |
| tools.okta_oar         | get_specific_request                    | `okta`, `mtls`, `ca_cert`             |
| tools.okta_oar         | get_user                                | `okta`, `mtls`, `ca_cert`             |
...
| tools.sentinel_one     | list_threats                            | `sentinel_one`, `mtls`, `ca_cert`     |
...
| tools.splunk           | add_kv_fields                           | `splunk`, `mtls`, `ca_cert`           |
| tools.splunk           | batch_save_kv_entries                   | `splunk`                              |
| tools.splunk           | create_kv_collection                    | `splunk`, `mtls`, `ca_cert`           |
| tools.splunk           | create_kv_entry                         | `splunk`, `mtls`, `ca_cert`           |
| tools.splunk           | delete_kv_collection                    | `splunk`, `mtls`, `ca_cert`           |
| tools.splunk           | delete_kv_entry                         | `splunk`, `mtls`, `ca_cert`           |
| tools.splunk           | discover_fields                         | `splunk`, `mtls`, `ca_cert`           |
| tools.splunk           | get_kv_collection                       | `splunk`, `mtls`, `ca_cert`           |
| tools.splunk           | get_kv_entry                            | `splunk`, `mtls`, `ca_cert`           |
| tools.splunk           | list_data_models                        | `splunk`, `mtls`, `ca_cert`           |
| tools.splunk           | list_field_extractions                  | `splunk`, `mtls`, `ca_cert`           |
| tools.splunk           | list_indexes                            | `splunk`, `mtls`, `ca_cert`           |
| tools.splunk           | list_kv_collections                     | `splunk`, `mtls`, `ca_cert`           |
| tools.splunk           | list_kv_entries                         | `splunk`, `mtls`, `ca_cert`           |
| tools.splunk           | list_sourcetypes                        | `splunk`, `mtls`, `ca_cert`           |
| tools.splunk           | search_events                           | `splunk`, `mtls`, `ca_cert`           |
| tools.splunk           | submit_hec_event                        | `splunk_hec`, `mtls`, `ca_cert`       |
| tools.splunk           | update_kv_entry                         | `splunk`, `mtls`, `ca_cert`           |
| tools.threatstream     | lookup_domain                           | `threatstream`, `mtls`, `ca_cert`     |
| tools.threatstream     | lookup_email                            | `threatstream`, `mtls`, `ca_cert`     |
| tools.threatstream     | lookup_file_hash                        | `threatstream`, `mtls`, `ca_cert`     |
| tools.threatstream     | lookup_ip_address                       | `threatstream`, `mtls`, `ca_cert`     |
| tools.threatstream     | lookup_url                              | `threatstream`, `mtls`, `ca_cert`     |
| tools.urlscan          | lookup_url                              | `urlscan`, `mtls`, `ca_cert`          |
| tools.virustotal       | lookup_domain                           | `virustotal`, `mtls`, `ca_cert`       |
| tools.virustotal       | lookup_file_hash                        | `virustotal`, `mtls`, `ca_cert`       |
| tools.virustotal       | lookup_ip_address                       | `virustotal`, `mtls`, `ca_cert`       |
| tools.virustotal       | lookup_url                              | `virustotal`, `mtls`, `ca_cert`       |
| tools.wazuh            | active_response                         | `wazuh_wui`, `mtls`, `ca_cert`        |
| tools.wazuh            | update_agents                           | `wazuh_wui`, `mtls`, `ca_cert`        |
| tools.zendesk          | get_group_users                         | `zendesk`, `mtls`, `ca_cert`          |
| tools.zendesk          | get_groups                              | `zendesk`, `mtls`, `ca_cert`          |
| tools.zendesk          | get_ticket                              | `zendesk`, `mtls`, `ca_cert`          |
| tools.zendesk          | get_ticket_attachments                  | `zendesk`, `mtls`, `ca_cert`          |
| tools.zendesk          | get_ticket_comments                     | `zendesk`, `mtls`, `ca_cert`          |
| tools.zendesk          | get_twilio_recordings                   | `zendesk`, `mtls`, `ca_cert`          |
| tools.zendesk          | search_tickets                          | `zendesk`, `mtls`, `ca_cert`          |
...
| `amazon_s3`            | -                                                                              | `AWS_ACCESS_KEY_ID` `AWS_PROFILE` `AWS_REGION` `AWS_ROLE_ARN` `AWS_SECRET_ACCESS_KEY`                              |
| `ansible`              | `PRIVATE_KEY`                                                                  | -                                                                                                                  |
| `aws`                  | -                                                                              | `AWS_ACCESS_KEY_ID` `AWS_PROFILE` `AWS_REGION` `AWS_ROLE_ARN` `AWS_SECRET_ACCESS_KEY`                              |
...
The `aws` and `amazon_s3` credentials support cross-account role assumption.
For that setup:

- Store the customer-provided target role in `AWS_ROLE_ARN`
- Set `AWS_REGION`
- Use the Tracecat-provided dedicated executor principal ARN and workspace
  External ID in the customer's trust policy
- Do not set `AWS_ROLE_SESSION_NAME`; Tracecat generates the STS session name

Tracecat shows these values in the workspace credential dialog:
