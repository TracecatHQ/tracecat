...
| Agent logs and traces | Export agent OTel metrics, logs, and traces.<br/>Set retention for agent telemetry.<br/>Alert on risky tool activity and approval decisions. | OpenTelemetry-compatible LLM observability tool |
