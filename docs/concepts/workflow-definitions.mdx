...
description: Ground truth for workflow execution.
---

You can think of a workflow defintion as an instruction manual that tells Tracecat how to execute a workflow.
When a workflow is triggered, Tracecat looks for the latest version of its workflow definition to execute.

- Definitions are the osurce of truth for a workflow
...
- **AI Autocompletion**: When used with an IDE AI copilot like `Supermaven` that learns your editing behavior, you can get AI-powered autocompletion for your YAML file.
