...
The agent add-ons entitlement adds `Agent presets` to `Active capabilities`, and the Tracecat-managed catalog connectors to `MCP integrations`. The screenshot below shows a workspace that has them.
