...
This is the JSONSchema7 definition for the integrations.microsoft_defender.list_defender_endpoint_alerts integration.

This integration requires secrets: `microsoft_defender_endpoint`
