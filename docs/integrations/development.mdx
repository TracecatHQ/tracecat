...
<Steps>
  ...
  <Step title="Install package and tracecat_registry">
    ...
    The `.[dev]` flag installs the development dependencies, which includes the [`tracecat`](https://github.com/TracecatHQ/tracecat) and [`tracecat_registry`](https://github.com/TracecatHQ/tracecat/tree/main/registry) [Python packages].
