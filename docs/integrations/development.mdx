...
<Steps>
  ...
  <Step title="Install package and tracecat_registry">
    ...
    The `.[dev]` flag installs the development dependencies, which includes the `tracecat_registry` [Python package](https://github.com/TracecatHQ/tracecat/tree/main/registry).
