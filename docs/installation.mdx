...
<iframe
  width="560"
  height="315"
  src="https://www.youtube.com/embed/JE79sa2KCyk"
...
<Warning>
  This setup has only been tested on MacOS, Linux (Ubuntu 20.04), and Windows
  WSL (Ubuntu 20.04). All with Docker Desktop and Docker Compose V2 installed.
</Warning>
...
Clone the `engine-0.1.0` tag from the Tracecat repository and navigate to the project root:
