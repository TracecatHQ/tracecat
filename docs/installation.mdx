...
Tracecat can be deployed locally with just 4 files.

Run these commands to download the files from the Tracecat github repository:

```bash
curl https://raw.githubusercontent.com/TracecatHQ/tracecat/main/docker-compose.yml -o docker-compose.yml
curl https://raw.githubusercontent.com/TracecatHQ/tracecat/main/env.sh -o env.sh
curl https://raw.githubusercontent.com/TracecatHQ/tracecat/main/.env.example -o .env.example
```
...
| `CLERK_`       | Clerk-specific environment variables                                                                           |
