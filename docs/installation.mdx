...
OPENAI_API_KEY=your-openai-api-key
TRACECAT__SELF_HOSTED_DB_BACKEND="postgres" # or "sqlite"
...
_Note: to generate a `TRACECAT__SERVICE_KEY` you'll need to create a Fernet key: https://cryptography.io/en/latest/fernet/._
