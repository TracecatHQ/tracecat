...
After acceptance the account holds the invited role organization-wide and lands on `/workspaces`. From the platform admin console, you can also invite an organization member for baseline access without an organization-wide role assignment.
