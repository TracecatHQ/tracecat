...
<Steps>
  ...
  <Step title="Connect your provider">
    ...
    For Bitbucket Cloud, click `Connect`, then enter your Atlassian account email and a [scoped API token](https://support.atlassian.com/bitbucket-cloud/docs/using-api-tokens/). Select all four [permissions](https://support.atlassian.com/bitbucket-cloud/docs/api-token-permissions/):
    ...
    The account must have access to the repository. Initialize the repository with a commit before syncing. For Bitbucket Data Center, connect its separate provider card with your HTTPS instance URL and an [HTTP access token](https://confluence.atlassian.com/bitbucketserver/http-access-tokens-939515499.html) granting repository write permission. Include any port and context path in the instance URL, such as `https://bitbucket.example.com:8443/bitbucket`.
