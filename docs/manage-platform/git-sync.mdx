---
title: "Git sync"
description: "Export workspace configuration to GitHub, GitLab, or Bitbucket Cloud as a pull request, then pull a reviewed commit into another workspace."
icon: "lock"
---
...
<Steps>
  ...
  <Step title="Connect your provider">
    ...
    The account must have access to the repository. Initialize the repository with a commit before syncing. Bitbucket Data Center is not supported.
...
<Steps>
  ...
  <Step title="Set the repository URL and save">
    For GitHub, `Select` lists repositories granted to the installation and `Manual` accepts any git+ssh URL; for GitLab or Bitbucket Cloud, enter the URL directly. Click `Save`.
