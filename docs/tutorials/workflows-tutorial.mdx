...
description: Learn how to create a workflow in Tracecat.
---
...
<Info>
  Deployed workflows runs automatically whenever a starting [Webhook
  action](/core/actions#action-types) receives new data.
</Info>
