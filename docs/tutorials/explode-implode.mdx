...
<Note>
  Download the workflow YAML files from the `playbooks/tutorials/` directory in our [GitHub repo](https://github.com/TracecatHQ/tracecat/tree/main/playbooks/tutorials).
</Note>
