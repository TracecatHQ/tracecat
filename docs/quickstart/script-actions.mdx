...
<CodeGroup>
  ...
  script: |
    def main(user_name, age, city, country):
      # Parameters map directly to input keys
      # Missing parameters get None (country not provided)
      if country is None:
  ...
  inputs:
    ...
    age: 30
    city: "New York"
    # country parameter will receive None
  ```
</CodeGroup>
