...
Read the generated `.env` file to better understand Tracecat's configurations. View the `.env.example` file [here](https://github.com/TracecatHQ/tracecat/blob/0.27.1/.env.example).
