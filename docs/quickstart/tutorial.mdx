...
<Note>
  Tracecat comes with a library of pre-built integrations in both YAML and Python.
  Find out more in the [integrations](/integrations/overview) docs.
</Note>

<AccordionGroup>
  <Accordion title="Search for integrations" icon="magnifying-glass">
...
- Learn how to trigger workflows via webhooks and schedules [here](/tutorials/workflow-triggers).
- Learn how to build your own custom integrations and templates [here](/tutorials/custom-integrations).
- Learn about Tracecat's inline functions in the [expressions](/quickstart/expressions) guide and the [functions](/cheatsheets/functions) cheatsheet.
