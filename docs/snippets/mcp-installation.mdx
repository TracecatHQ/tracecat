<Tabs sync={false}>
  ...
  <Tab title="Cursor" icon="https://cdn.simpleicons.org/cursor">
    ...
    Click this link [Add Tracecat to Cursor](https://cursor.com/en-US/install-mcp?name=tracecat&config=eyJ1cmwiOiJodHRwczovL3BsYXRmb3JtLnRyYWNlY2F0LmNvbS9tY3AifQ)
