...
<Steps>
  <Step title="Log into Tracecat">
    <Note>
        If you are working with a brand new Tracecat deployment, you can find the default admin user's email and password in the [authentication docs](http://localhost:3000/self-hosting/authentication/introduction).
    </Note>
  </Step>
