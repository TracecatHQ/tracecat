...
<Steps>
  ...
  <Step title="Configure VirusTotal action inputs">
    <Tip>
        Tracecat comes with a powerful templating language called "expressions" and a JSONPath-like syntax to reference data directly in action inputs.
  ...
  <Step title="Add secret">
    ...
    <Note>
      Must pre-built integrations have been configured with a specific secret name and required keys.
      Find out more about secrets in our [docs](/platform/secrets).
    </Note>
  </Step>
